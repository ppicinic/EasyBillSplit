...
public class UserGroupDao extends AbstractDao<UserGroup, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, UserGroup entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public UserGroup readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, UserGroup entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(UserGroup entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(UserGroup entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
